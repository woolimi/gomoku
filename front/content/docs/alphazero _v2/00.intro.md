...
The live result is playable at **[sungyongcho.com/gomoku](https://sungyongcho.com/gomoku)** — select AlphaZero in game settings.
...
- 13-channel state encoding (position, captures, move history, forbidden points)
- 200–2400 MCTS simulations per move during training, 200 in production (native C++)
