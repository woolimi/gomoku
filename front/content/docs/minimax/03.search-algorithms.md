...
On an opening position (~200 legal moves), plain alpha-beta at depth 5 takes ~4s. PVS with transposition table and killer moves reaches depth 10 in ~2.3s — the optimizations don't just enable deeper search, they make it faster than shallow search without them.
