...
The sidebar tracks the average AI response time across all AI moves in the current session, displayed at the bottom of the game history panel. This is computed from the `executionTime` field returned with each AI move (see [WebSocket JSON Protocol](/docs/about-project/websocket-json-protocol)).
