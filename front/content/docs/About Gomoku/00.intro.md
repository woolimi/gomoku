...
In addition, we have implemented several advanced features to enhance gameplay. These include a **History Mode** for reviewing previous moves, **Undo Turn / Undo Move**, **URL and JSON import/export** capabilities for sharing or restoring game states, and an **Evaluation System** that analyzes and scores the current move. These features are explained in more detail in the [Features](/docs/about-gomoku/features) section.
