(() => {
  ...
  Object.entries(NODES).forEach(([id, n]) => {
    ...
    if (n.type !== "leaf") {
      ...
      retText.setAttribute("font-size", "10");
  ...
  function addCutoffLabel(nodeId) {
    ...
    const existing = document.getElementById(`cutoff-${nodeId}`);
    if (existing) return;
  ...
  function applyStep(idx) {
    ...
    if (step.finalResult) {
      ...
      rootEl.retText.setAttribute("font-size", "13");
    }
  }
