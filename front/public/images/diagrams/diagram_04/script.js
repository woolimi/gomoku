(() => {
  ...
  function mkText(p, x, y, txt, sz, wt, fill, anc) {
    ...
    t.setAttribute("font-size", sz || "10"); t.setAttribute("font-weight", wt || "400");
  ...
  function applyStep(idx) {
    ...
    document.getElementById("subtitle").innerHTML = step.subtitle || "";
    document.getElementById("footer").innerHTML = step.footer || "";
